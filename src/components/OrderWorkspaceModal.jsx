    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 bg-background border border-border rounded-lg shadow-2xl flex flex-col"
        ...
        <div className="flex items-start justify-between px-6 py-4 border-b border-border flex-shrink-0">
          <div>
            <h2 className="text-lg font-semibold text-foreground">Draft Order Workspace</h2>
            <p className="text-sm text-muted-foreground font-mono mt-0.5">{order.orderNumber}</p>
          </div>
          <button
            onClick={onClose}
