...
Deno.serve(async (req) => {
  ...
  const requestMetadata = {
    ...
    planned_takeoff_date: planned_takeoff_date || expiryDate,
    store_closed_date,
    next_trading_day,
    holiday_flag: Boolean(holiday_flag),
    closure_reason,
    takeoff_status,
